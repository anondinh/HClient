...
public enum Emote {
    ...
    SqShy("https://cdn.betterttv.net/emote/59cf182fcbe2693d59d7bf46/1x"),
    Wowee("https://cdn.betterttv.net/emote/58d2e73058d8950a875ad027/1x");

    private String destination;

    Emote(String destination) {
